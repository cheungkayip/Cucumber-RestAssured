...
# TESTCASE CAR 0801 EXISTING Policy MODIFY Insurance ADD ADDITIONAL PASSENGERINJURIES Simulating the GET and POST actions that happens through the application
@Integration
@ChangeScenario
Feature: car_existing_modifyAddPassengerInjuries
  ...
  Scenario: POST additional endpoint
    ...
    """
    {"additionalCoverages":["NoClaimProtection","RoadAssistanceNetherlands","PassengerInjuries"]}
    """
    Then response should have status code "200"
