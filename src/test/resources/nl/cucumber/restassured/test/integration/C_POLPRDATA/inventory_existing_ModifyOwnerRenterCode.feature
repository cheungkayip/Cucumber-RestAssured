...
# TESTCASE INVENTORY 0810 OwnerRenterCode
@ChangeScenario
@C_POLPRDATA
Feature: inventory_existing_ModifyOwnerRenterCode
  ...
  Scenario: POST Basis gegevens Changed inventoryValue
    ...
    """
    {"startDate":"dateChange","houseHold":"01","studentFlag":"true","ownerRenterCode":"2","inventoryValue":"01","lodger":"true"}
    """
    Then response should have status code "200"
