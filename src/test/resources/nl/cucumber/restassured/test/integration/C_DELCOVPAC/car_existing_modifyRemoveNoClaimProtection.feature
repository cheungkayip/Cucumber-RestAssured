# TESTCASE CAR 0801 EXISTING Policy MODIFY Insurance REMOVE ADDITIONAL NO CLAIM Simulating the GET and POST actions that happens through the application
@Integration
@ChangeScenario
Feature: car_existing_modifyRemoveNoClaimProtection
  ...
  Scenario: POST Summarize screen save and validate request of SaveOrderStartBpm
    ...
    And XML "req" of "SaveOrderStartBpm" should contain:
      ...
      | NVP:ChangeScenarioChangeActionReferenceUID_1_001001  | Car-Car_Cirp_1-Coverage-NoClaimProtection-1Car-Car_Cirp_1-Coverage-NoClaimProtection-2               |
      | NVP:ChangeScenarioChangeScenarioCode002              | null                                                                                                 |