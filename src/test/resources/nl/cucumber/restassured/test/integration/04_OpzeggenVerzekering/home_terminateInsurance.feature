@Integration
@Discontinue
Feature: home_terminateInsurance

  Scenario: Login with MarkGeel
    Given I want to login with user "MarkGeel"
    Then response should have status code "302"

  Scenario: Start a Home disconnect flow
    Given I start a flowType "DISCONNECT" flow and productTypeCode "0809" and overeenkomstId "333333" and object "1111AA_1_C_hoog"
