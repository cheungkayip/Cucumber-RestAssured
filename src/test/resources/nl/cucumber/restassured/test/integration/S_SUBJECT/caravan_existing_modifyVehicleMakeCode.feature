...
# TESTCASE CARAVAN 0813 Change Insured Object
@ChangeScenario
@S_SUBJECT
Feature: caravan_existing_modifyVehicleMakeCode
  ...
  Scenario: POST licenseAnswers caravan with chassisNumber
    ...
    """
    {"sameLicensePlateAsCar":"true","licensePlate":null,"chassisNumber":"KIP12345678","caravanType":"9010201","brand":"0091","yearOfConstruction":"2016","hailResistanceRoof":"false"}
    """
    Then response should have status code "200"
