...
@ChangeScenario
Feature: oldtimer_car_modifyAddRoadAssistanceAndAbroad
  ...
  Scenario: POST basicAnswers oldtimer
    ...
    """
    {"driverAnswers":{"regularDriverCode":"0001","birthDate":"13-05-1995","initials":"M.I.N","genderCode":"1","surname":"Geel","relationToDriver":"0001"},"assessedValueAmount":"20000","startDate":"01-01-2017"}
    """
    Then response should have status code "200"
  ...
  Scenario: POST additional endpoint
    ...
    """
    {"additionalCoverages":["PassengerInjuries","RoadAssistanceAbroad"]}
    """
    Then response should have status code "200"
