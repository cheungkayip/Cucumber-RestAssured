# TC to test the sequence of the Change Scenarios when changing the insurance and deleting a coverage from that insurance
@Integration
@ChangeScenario
Feature: travel_modifyCoverageAreaCode+DeleteACoverage
  ...
  Scenario: POST selected coverage endpoint
    ...
    """
    {"selectedCoverages":["TravelPersonalAssistance","TravelMedical"]}
    """
    Then response should have status code "200"
  ...
  Scenario: POST Summarize screen SaveOrderStartBpm
    ...
    And XML "req" of "SaveOrderStartBpm" should contain:
      ...
      | NVP:ChangeScenarioChangeScenarioCode2                | C_DELCOVPAC                                                                    |
      | NVP:ChangeScenarioSequenceNumber2                    | 2                                                                              |
      | NVP:ChangeScenarioChangeActionChangeActionCode002001 | DELCOVPAC                                                                      |
      | NVP:ChangeScenarioChangeActionDate002001             | dateChange                                                                     |
      | NVP:ChangeScenarioChangeActionReferenceUID_1_002001  | LongTermTravel-LongTermTravel_Cirp_1-Coverage-BreakdownAssistanceVehicle-1LongTermTravel-LongTermTra |
