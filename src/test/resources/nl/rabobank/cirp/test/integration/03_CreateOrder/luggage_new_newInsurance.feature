@Integration
@CreateOrder
Feature: luggage_new_newInsurance

  Scenario: Authorize with user Mike Wazowski
    Given I want to login with user "MikeWazowski"
    Then response should have status code "302"

  Scenario: Start luggage with a new policy and new insurance flow
    Given I create a "NEW" flow and productCode "0815"
  ...
  Scenario: POST basisAnswers luggage
  ...
  Scenario: POST to selected coverage
    ...
    """
    {"continuousCoverageAmount":"3000","selectedCoverages":["LuggageContinuous"]}
    """
    Then response should have status code "200"
