@Integration
@Discontinue
Feature: liability_terminateInsurance

  Scenario: Login with MarkGeel
    Given I want to login with user "MarkGeel"
    Then response should have status code "302"

  Scenario: Start a Liability disconnect flow
    Given I start a flowType "DISCONNECT" flow and productTypeCode "0811" and overeenkomstId "333333" and object ""
