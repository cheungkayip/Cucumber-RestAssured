@Integration
@Discontinue
Feature: travel_terminateInsurance

  Scenario: Login with MarkGeel
    Given I want to login with user "MarkGeel"
    Then response should have status code "302"

  Scenario: Start a Travel disconnect flow
    Given I start a flowType "DISCONNECT" flow and productTypeCode "0814" and overeenkomstId "333333" and object ""
