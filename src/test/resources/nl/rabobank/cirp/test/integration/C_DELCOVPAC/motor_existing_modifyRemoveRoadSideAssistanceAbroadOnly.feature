...
# TESTCASE MOT 0801 EXISTING Policy MODIFY Insurance REMOVE ADDITIONAL ROAD ASSISTANCE ABROAD only Simulating the GET and POST actions that happens through the application

@Integration
@ChangeScenario
Feature: motor_existing_modifyRemoveRoadSideAssistanceAbroadOnly
  ...
  Scenario: POST basicAnswers motor
    ...
    """
    {"driverAnswers":{"regularDriverCode":"0001","birthDate":"13-05-1995","initials":"M.I.N","genderCode":"1","surname":"Geel","relationToDriver":"0001"},"claimFreeYears":"10","startDate":"dateChange","winterReduction":"true"}
    """
    Then response should have status code "200"
  ...
  Scenario: POST selected-additional endpoint
    ...
    """
    {"additionalCoverages":["PassengerInjuries","NoClaimProtection","RoadAssistanceNetherlands"]}
    """
    Then response should have status code "200"
  ...
  Scenario: POST Summarize screen save and validate request of SaveOrderStartBpm
    ...
    And XML "req" of "SaveOrderStartBpm" should contain:
      | name                                                 | value                                                                                                |
      | RelationId                                           | 999990000000204                                                                                      |
      | NVP:ChangeScenarioChangeScenarioCode1                | C_DELCOVPAC                                                                                          |
      ...
      | NVP:ChangeScenarioChangeActionReferenceUID_1_001001  | RoadSideAssist-Motor_Cirp_1-Coverage-RoadAssistanceAbroad-1RoadSideAssist-Motor_Cirp_1-Coverage-Road |
      | NVP:ChangeScenarioChangeActionReferenceUID_2_001001  | AssistanceAbroad-2 |
