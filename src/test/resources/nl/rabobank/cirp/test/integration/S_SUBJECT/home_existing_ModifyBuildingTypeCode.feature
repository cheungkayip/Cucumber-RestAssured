...
# http://jira.rabobank.nl/browse/VKVMINION-1248
# TESTCASE HOME 0809 EXISTING Policy MODIFY BuildingTypeCode and RoofTypeCode Simulating the GET and POST actions that happens through the application
# BuildingTypeCode (FrontEnd attribute) changes the CustomerBuildingGroupCode and BuildingGroupCode (BM attribute)
@Integration
@ChangeScenario
@S_SUBJECT
Feature: home_existing_ModifyBuildingTypeCode
  ...
  Scenario: POST Uw Woning AddressAnswers
    ...
    """
    {"postalCode":"1111AA","houseNumber":"1","buildingType":"9020104","roofType":"02","multipleAddressIndex":null}
    """
    Then response should have status code "200"
  ...
  Scenario: POST Summarize save SaveOrderStartBpm
    ...
    And XML "req" of "SaveOrderStartBpm" should contain:
      ...
      | NVP:ChangeScenarioChangeActionReferenceUID_1_001001  | InsuredObject_Home_Cirp_1_1InsuredObject_Home_Cirp_1_2 |
