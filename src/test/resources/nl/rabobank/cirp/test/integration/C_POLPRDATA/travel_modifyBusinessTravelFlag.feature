...
# TESTCASE TRAVEL 0814 BusinessTravelFlag
@ChangeScenario
@C_POLPRDATA
Feature: travel_modifyBusinessTravelFlag
  ...
  Scenario: POST basicAnswers travel
    ...
    """
    {"startDate":"dateChange","houseHold":"01","travelDurationUninterrupted":"03","coverageAreaCodeFlag":"true","winterAndUnderwaterSportsFlag":"true","businessTravelFlag":"false","studentFlag":"true"}
    """
    Then response should have status code "200"
