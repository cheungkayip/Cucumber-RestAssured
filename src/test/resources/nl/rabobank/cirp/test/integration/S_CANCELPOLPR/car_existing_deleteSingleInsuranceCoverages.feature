...
@Integration
@ChangeScenario
Feature: car_existing_deleteSingleInsuranceCoverages
  ...
  Scenario: Start a Car disconnect flow
    Given I start a flowType "DISCONNECT" flow and productTypeCode "0801" and overeenkomstId "333333" and object "CR2222"
