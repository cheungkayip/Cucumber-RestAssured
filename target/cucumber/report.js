...
formatter.scenario({
  "line": 4,
  "name": "Authorize with user MarkGeel",
  "description": "",
  "id": "test-all-races-in-season-2016;authorize-with-user-markgeel",
  "type": "scenario",
  "keyword": "Scenario"
});
formatter.step({
...
formatter.match({
  ...
  "location": "RestStepDefinitions.checkTotalAmountOfRaces()"
});
formatter.result({
  "status": "skipped"
});
